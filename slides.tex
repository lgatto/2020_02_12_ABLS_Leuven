...
\begin{frame}
  ...
  \begin{itemize}
  \item organelle-specific profiles modelled as mixtures of Gaussian
    process regression models \citep{Crook:2019b};
  \item explicit modelling of replicates;
  \item no assumption with regard to similarity between conditions;
  \item rigorous interpretation of the results and uncertainty
...
\begin{frame}
  \begin{figure}[h]
    ...
    \caption{\textbf{\textcolor{Blue}{Differential localisation
      ...
      discrimination of differentially localised (1) vs. static
      proteins (2).}
  \end{figure}
\end{frame}
